...
import { getDisplayName } from 'next/dist/next-server/lib/utils.js'
import { isLocale } from '../translations/types'
import { LocaleProvider } from '../context/LocaleContext'

console.log('withLocale.js')

let WithLocaleWrapper = (WrappedPage) => {
...
export default WithLocaleWrapper